./mvnw clean package
docker image build --force-rm -t "petclinic-admin-server:dev" ./spring-petclinic-admin-server
docker image build --force-rm -t "petclinic-api-gateway:dev" ./spring-petclinic-api-gateway
docker image build --force-rm -t "petclinic-config-server:dev" ./spring-petclinic-config-server
